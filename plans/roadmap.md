...
- **V3 — `addDecl.WF`, inductive case.** Generalize what the concrete replay
  ...
  Next construct the coherent canonical replay from the retained execution,
  supply primitive readiness, derive selecting-minor and persistent eta-rule
