...
- **V3 — `addDecl.WF`, inductive case.** Generalize what the concrete replay
  ...
  next construct and wire the nonprimitive singleton-structure registration
  artifacts into the shared completion, then close `addDecl.WF`.
