...
- **V3 — `addDecl.WF`, inductive case.** Generalize what the concrete replay
  ...
  endpoints directly to the public replay. Next derive the canonical Bool/Nat
  semantic translation lists, generation `WF`, and rule fold, supply primitive
  readiness, derive
