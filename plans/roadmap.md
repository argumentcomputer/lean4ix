...
- **V3 — `addDecl.WF`, inductive case.** Generalize what the concrete replay
  ...
  Next assemble the retained semantic run from the public execution, supply
  primitive readiness, derive selecting-minor and persistent eta-rule
