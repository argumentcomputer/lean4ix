...
#check VEnv.SpineWF.arg_hasType
#check VEnv.HasType.spineWF_of_appN
...
#check VStructureView.WF.projectionMotiveSpine
#check VStructureView.WF.projectionCommonSpine
#check VStructureView.WF.projectionMinorType_isType
#check VStructureView.WF.projectionIHTypes_onTel
