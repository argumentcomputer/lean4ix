...
/-!
# Nat.mod/div reflected-condition selector evidence

Packages a successful \`Condition.natLE\` check as a semantic selector and
connects the retained equations to the already-certified direct \`Nat.ble\`
semantics. This is the branch-selection layer shared by the later Nat.mod and
Nat.div conservation proofs.
-/
  ...
  have hevidence : ∀ e ∈ Condition.natLEEvidenceExpressions,
    ...
    have hclosed : ∀ e ∈ Condition.natLEEvidenceExpressions,
      ...
      simp [Condition.natLEEvidenceExpressions, Condition.natLE,
        ...
        Reflection.natDITE, Expr.FVarsIn, FVarsIn, Level.hasMVar',
